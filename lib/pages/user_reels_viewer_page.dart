...
class UserReelsViewerPage extends StatefulWidget {
  final List<Map<String, dynamic>> reels;
  final int initialIndex;

  const UserReelsViewerPage({
    super.key,
    required this.reels,
  ...
  @override
  State<UserReelsViewerPage> createState() => _UserReelsViewerPageState();
}

class _UserReelsViewerPageState extends State<UserReelsViewerPage> {
