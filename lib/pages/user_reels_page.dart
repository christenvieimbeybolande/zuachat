...
import '../api/api_fetch_user_reels.dart';
import 'user_reels_viewer_page.dart';
...
class _UserReelsPageState extends State<UserReelsPage> {
  ...
  // ============================================================
  // 📥 CHARGEMENT DES REELS PUBLICS DE L’UTILISATEUR
  // ============================================================
  Future<void> _load({required bool reset}) async {
    ...
    final res = await apiFetchUserReels(
